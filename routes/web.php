...
Route::get('catalogo', 'ProductoController@categorias');
Route::get('catalogo/{categoria}', 'ProductoController@productos');
Route::get('catalogo/{categoria}/{producto}', 'ProductoController@detalle');
Route::get('sucursales', 'SucursalesController@front');
Route::get('revendedores', 'RevendedoresController@front');
...
Route::group(['prefix' => 'adm'], function() {
	...
	Route::group(['prefix' => 'productos'], function() {
		...
		Route::group(['prefix' => 'producto'], function() {
			Route::get('create', 'ProductoController@crearProducto');
			Route::get('edit', 'ProductoController@listarProductos');
			Route::post('edit', 'ProductoController@listarPorCategoria');
			Route::get('edit/{id}', 'ProductoController@editarProducto');
		});

		Route::group(['prefix' => 'categoria'], function() {
			Route::get('create', 'CategoriaController@crearCategoria');
			Route::get('edit', 'CategoriaController@listarCategorias');
			Route::get('edit/{id}', 'CategoriaController@editarCategoria');
		});
