...
<html lang="es">
	...
	<head>
		...
		<title>COSMOS - Panel de administraci&oacuten - @yield('title')</title>
			...
			<ul id="nav-mobile" class="side-nav fixed">
				...
				<li class="no-padding">
					...
					<ul class="collapsible collapsible-accordion">
						...
						<li class="bold"><a class="collapsible-header waves-effect waves-admin @if($seccion=="empresa") active @endif"><i class="material-icons">home</i>Empresa</a>
							<div class="collapsible-body">
								<ul>
									...
									<li class="@if($subseccion=="item/edit/2") active @endif"><a href="{{ url('adm/empresa/item/edit/2') }}">Editar texto</a></li>
								</ul>
							</div>
						</li>

						<li class="bold"><a class="collapsible-header waves-effect waves-admin @if($seccion=="productos") active @endif"><i class="material-icons">home</i>Productos</a>
							<div class="collapsible-body">
								<ul>
									<li class="@if($subseccion=="categoria/create") active @endif"><a href="{{ url('adm/productos/categoria/create') }}">Crear categoria</a></li>
									<li class="@if($subseccion=="categoria/edit") active @endif"><a href="{{ url('adm/productos/categoria/edit') }}">Editar categoria</a></li>
									<li class="@if($subseccion=="producto/create") active @endif"><a href="{{ url('adm/productos/producto/create') }}">Crear producto</a></li>
									<li class="@if($subseccion=="producto/edit") active @endif"><a href="{{ url('adm/productos/producto/edit') }}">Editar productos</a></li>
								</ul>
							</div>
						</li>

						<li class="bold"><a class="collapsible-header waves-effect waves-admin @if($seccion=="calidad") active @endif"><i class="material-icons">home</i>Sucursales</a>
							<div class="collapsible-body">
								<ul>
									<li class="@if($subseccion=="texto/edit/3") active @endif"><a href="{{ url('adm/sucursales/texto/edit/3') }}">Editar sucursal 1</a></li>
									<li class="@if($subseccion=="texto/edit/4") active @endif"><a href="{{ url('adm/sucursales/texto/edit/4') }}">Editar sucursal 2</a></li>
								</ul>
							</div>
						</li>

						<li class="bold"><a class="collapsible-header waves-effect waves-admin @if($seccion=="catalogo") active @endif"><i class="material-icons">home</i>Revendedores</a>
							<div class="collapsible-body">
								<ul>
									<li class="@if($subseccion=="texto/edit/5") active @endif"><a href="{{ url('adm/revendedores/texto/edit/5') }}">Editar Texto</a></li>
								</ul>
							</div>
						</li>

						<li class="bold"><a class="collapsible-header waves-effect waves-admin @if($seccion=="catalogo") active @endif"><i class="material-icons">home</i>Atencion a Empresas</a>
							<div class="collapsible-body">
								<ul>
									<li class="@if($subseccion=="texto/edit/6") active @endif"><a href="{{ url('adm/atencion/texto/edit/6') }}">Editar Texto</a></li>
									<li class="@if($subseccion=="icono/create") active @endif"><a href="{{ url('adm/atencion/icono/create') }}">Crear Icono</a></li>
									<li class="@if($subseccion=="icono/edit") active @endif"><a href="{{ url('adm/atencion/icono/edit') }}">Editar Icono</a></li>
								</ul>
							</div>
						</li>

						<li class="bold"><a class="collapsible-header waves-effect waves-admin @if($seccion=="catalogo") active @endif"><i class="material-icons">home</i>Formas de envio</a>
							<div class="collapsible-body">
								<ul>
									<li class="@if($subseccion=="texto/edit/7") active @endif"><a href="{{ url('adm/formas/texto/edit/7') }}">Editar Texto 1</a></li>
									<li class="@if($subseccion=="item/edit/3") active @endif"><a href="{{ url('adm/formas/item/edit/3') }}">Editar texto 2</a></li>
								</ul>
							</div>
						</li>
